  ...
  void addContactsToList() async {
    ...
    _firestore
      ...
      for (var doc in snapshot.docs) {
        ...
        DateTime currTime = doc.data()['contact time']
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          'Khobidi Trace(credit to Diganta Kalita)',
          style: TextStyle(
              ...
              child: Container(
                ...
                child: Row(
                  children: <Widget>[
                    Card(
                      child: Image(
                        image: AssetImage('images/corona_spin.gif'),
                        fit: BoxFit.cover,
                      ),
                    ),
                    Expanded(
